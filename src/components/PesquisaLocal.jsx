...
//   const [ posicaoAtual, setPosicaoAtual ] = useState([0, 0]);
//   const [ posicaoMarcada, setPosicaoMarcada ] = useState(null);
...
//       )
//     } else {
//       console.error('Navegador não suporta geolocalizacão');
//     }
//   }, [])
...
//     useMapEvents({
//       click(e) {
//         setPosicaoMarcada([e.latlng.lat, e.latlng.lng]);
//       },
//     });

//     return posicaoMarcada === null ? null : (
//       <Marker 
//         position={posicaoMarcada}
//         icon={customPinIcon}
//       >
...
//       />
//       <RecenterMap position={posicaoAtual} />
//       <LocationMarker />
//     </MapContainer>
//   )
// }
